...
export const messages = {
  zh: {
    ...
    lifecycle: "生命周期", deprecationDate: "下线日期", lifecycleActive: "在售", lifecycleDeprecated: "即将下线", lifecycleSunset: "已下线",
    onlyActive: "只看在售", recentOpenWeights: "开源仅近 1 年", customColumns: "自定义列", deprecatingIn: "天后下线", deprecatedDaysAgo: "天前已下线",
    ...
    qualityDescription: "ai-pricing 自动拉取的 AAIndex 外部证据，仅覆盖映射到 models.json 的模型。",
  ...
  en: {
    ...
    lifecycle: "Lifecycle", deprecationDate: "Deprecation", lifecycleActive: "Active", lifecycleDeprecated: "Deprecating", lifecycleSunset: "Sunset",
    onlyActive: "Active only", recentOpenWeights: "Open weights ≤ 1yr", customColumns: "Columns", deprecatingIn: "days to sunset", deprecatedDaysAgo: "days since sunset",
    ...
    qualityDescription: "AAIndex evidence fetched from ai-pricing, limited to models mapped into models.json.",
