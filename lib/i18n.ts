...
export const messages = {
  zh: {
    ...
    qualityEvidence: "AAIndex 外部证据", mappedModels: "已映射模型", noResults: "没有符合当前条件的数据", loading: "正在加载目录", error: "页面加载失败",
  ...
  en: {
    ...
    qualityEvidence: "AAIndex evidence", mappedModels: "Mapped models", noResults: "No data matches these filters", loading: "Loading catalog", error: "Page failed to load",
